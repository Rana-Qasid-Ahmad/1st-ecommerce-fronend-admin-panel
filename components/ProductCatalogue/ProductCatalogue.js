...
function ProductCatalogue({ api }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${api}?sort=${sort}&sortOrder=${sortOrder}`);
            ...
            <div className={`${styles.inner}`}>
                ...
                <div className={`${styles.productCatalogue}`}>
                    {loading ? (
                        ...
                        <div> <div className="products-area-wrapper tableView">
                            <div className="products-header">
                                <div className="product-cell image" >
                                    <div onClick={() => { setSort("name")}} >Items</div>
                                ...
                                <div className="product-cell stock"><div onClick={() => { setSort("stock") }}>Stock</div>
                                    <button className="sort-button" onClick={()=>{toggleSortOrder()}} >
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512"><path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z" /></svg>
                                    </button></div>
                                <div className="product-cell price" ><div onClick={() => { setSort("price") }}>Price</div><button className="sort-button" onClick={()=>{toggleSortOrder()}}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512"><path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z" /></svg>
                                </button></div>
                            </div>
                            {data.map((item, index) => (
                                <div key={index} className="products-row">
                                    ...
                                    <div className="product-cell image">
                                        ...
                                        <Link href={{ pathname: `${item.id}` }}> <span>{item.name}</span></Link>
                                    </div>
                                    ...
                                    <div className="product-cell sales"><span className="cell-label">Sales:</span>12</div>
                                    <div className="product-cell stock"><span className="cell-label">Stock:</span>{item.stock}</div>
                                    <div className="product-cell price"><span className="cell-label">Price:</span>${item.price}</div>
                                </div>
